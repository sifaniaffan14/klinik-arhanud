        ...
        <form action="" id="deleteForm" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <p class="text-center">Apakah anda yakin untuk menghapus pasien? Data yang sudah dihapus tidak bisa
                        kembali</p>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <select class="form-control " name="Pendidikan_terakhir" placeholder="Pendidikan terakhir"
                            ...
                            <option value="" {{ $data->pendidikan == '' ? 'selected' : ''  }} disabled>Pendidikan
                                Terakhir</option>
                            <option value="Tidak Sekolah" {{ $data->pendidikan == 'Tidak Sekolah' ? 'selected' : ''  }}>
                            ...
                            <option value="Perguruan Tinggi"
                                {{ $data->pendidikan == 'Perguruan Tinggi' ? 'selected' : ''  }}>Perguruan Tinggi
                            </option>
                        </select>
                    </div>
                    <div class="col-sm-6">
